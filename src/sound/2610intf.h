...
/* Chip 0 functions								*/
/************************************************/
u32 YM2610_status_port_0_A_r(u32 offset);
u32 YM2610_status_port_0_B_r(u32 offset);
u32 YM2610_read_port_0_r(u32 offset);
void YM2610_control_port_0_A_w(u32 offset, u32 data);
void YM2610_control_port_0_B_w(u32 offset, u32 data);
void YM2610_data_port_0_A_w(u32 offset, u32 data);
void YM2610_data_port_0_B_w(u32 offset, u32 data);
...
/* Chip 1 functions				*/
/************************************************/
//u32  YM2610_status_port_1_A_r (u32 offset);
//u32  YM2610_status_port_1_B_r (u32 offset);
//u32  YM2610_read_port_1_r (u32 offset);
//void  YM2610_control_port_1_A_w (u32 offset,u32 data);
//void  YM2610_control_port_1_B_w (u32 offset,u32 data);
//void  YM2610_data_port_1_A_w (u32 offset,u32 data);
//void  YM2610_data_port_1_B_w (u32 offset,u32 data);
